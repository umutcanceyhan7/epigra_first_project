<p align="center">This project aims to go [SpaceX API](https://api.spacexdata.com/v3/capsules)[Duck Duck Go](https://duckduckgo.com). and fetch the capsule datas from it by using PHP.</p>
